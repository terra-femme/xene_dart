      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            // Tiny platform dot (only place platform color is used)
            Container(
              width: 5,
              height: 5,
              decoration: BoxDecoration(
            ...
            // Remove
            GestureDetector(
              onTap: () => ref.read(queueProvider.notifier).removeItem(item.id),
              child: const Icon(Icons.close, size: 14, color: _lightGray),
            ),
          ],
        ),
      ),
