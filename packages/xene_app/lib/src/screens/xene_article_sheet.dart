  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return async.when(
      ...
      data: (article) {
        ...
        final accent = _parseThemeColor(article.themeColor) ??
        ...
        return CustomScrollView(
          ...
          slivers: [
            ...
            SliverList.builder(
              ...
              itemBuilder: (context, i) => _BlockRenderer(
                block: article.blocks[i],
                accent: accent,
              ),
            ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          // Template label
          Text(
            article.layoutTemplate.toUpperCase().replaceAll('_', ' '),
            style: GoogleFonts.dmMono(
              fontSize: 10,
...
class _VideoBlock extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hasThumb = block.thumbnailUrl != null &&
        block.thumbnailUrl!.isNotEmpty;
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 16),
